<nav class="navbar navbar-expand-lg fixed-top bg-dark">
    ...
    <a class="barbeariaHeader" href="index.php"><h3><strong>Barbearia #</strong></h3></a>
      ...
      <div class="collapse k navbar-collapse" id="navbarNavDarkDropdown">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a class="nav-link active bg-gradient-danger me-5" aria-current="page" href="index.php">Home</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link bg-gradient-danger me-5" href="index.php#quem-somos">Quem Somos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link bg-gradient-danger me-5" href="index.php#servicos">Serviços</a>
          </li>
          ...
          <li class="nav-item dropdown me-5">
            ...
            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
              <li><a class="dropdown-item" href="index.php#galeria">Galeria</a></li>
              <li><a class="dropdown-item" href="index.php#contato">Contato</a></li>
              <li><a class="dropdown-item" href="index.php#localizacao">Localização</a></li>
            </ul>
          </li>

          <li class="nav-item">
            <a class="btn btn-outline-primary bg-gradient-danger me-5" href="login.php">Fazer Login</a>
          </li>
