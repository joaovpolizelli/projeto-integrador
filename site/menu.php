    ...
    <a class="barbeariaHeader" href="login.php?redirect=home"><h3><strong>Barbearia #</strong></h3></a>
      ...
      <div class="collapse k navbar-collapse" id="navbarNavDarkDropdown">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a class="nav-link active bg-gradient-danger me-5" aria-current="page" href="login.php?redirect=home">Home</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link bg-gradient-danger me-5" href="login.php?redirect=quem-somos">Quem Somos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link bg-gradient-danger me-5" href="login.php?redirect=servicos">Serviços</a>
          </li>
          ...
          <li class="nav-item dropdown me-5">
            ...
            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
              <li><a class="dropdown-item" href="login.php?redirect=galeria">Galeria</a></li>
              <li><a class="dropdown-item" href="login.php?redirect=contato">Contato</a></li>
              <li><a class="dropdown-item" href="login.php?redirect=localizacao">Localização</a></li>
            </ul>
          </li>
